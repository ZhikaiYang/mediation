...
```{r}
ifg5 <- subset(i1, medi %in% "AC148152.3_FG001")

#v34 <- fread("cache/gene_v34_conversion.txt", data.table=FALSE)
fg5 <- subset(v34, V1 %in% "AC148152.3_FG001")
...
```{r}
ifg5 <- subset(i1, medi %in% "AC148152.3_FG008")

#v34 <- fread("cache/gene_v34_conversion.txt", data.table=FALSE)
fg5 <- subset(v34, V1 %in% "AC148152.3_FG008")

# 238143557

chr2 <- subset(ifg5, seq == 2)

chr2$dist <- chr2$Pos - 238074569

...
write.table(df, "largedata/df_job_control_ag.csv", sep=",", row.names=FALSE, quote=FALSE)
...
```{r}
library("huskeR")
run_Rcode(inputdf=data.frame(file=1:280, out=NA), outdir="slurm-script", cmdno = 10, 

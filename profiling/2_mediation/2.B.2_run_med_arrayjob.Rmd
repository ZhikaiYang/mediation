...
```{r}
library("huskeR")
run_Rcode(inputdf=data.frame(file=4:13, out=NA), outdir="slurm-script", cmdno = 5, 
          rcodes = "profiling/2_mediation/2.B.1_setup_med_job.R",
          rversion="3.5",
          base_shid = "med_test",
          email="zhikaiyang911@gmail.com", 
          runinfo = c(FALSE, "jyanglab", 16, "60G", "6:00:00"))
###>>> In this path: cd /common/jyanglab/jyang21/projects/mediation
###>>> RUN: sbatch -p batch --licenses=common --nodes=1 --ntasks=16 --mem 200G --time=6:00:00 slurm-script/med_test_array.sh
```

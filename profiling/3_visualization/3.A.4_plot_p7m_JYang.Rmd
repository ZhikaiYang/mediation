...
df[df$trait %in% c("tpb", "tsl"), ]$cat <- "Female Inflorescence"
df[df$trait %in% c("cobd", "cobl", "cobw",  "ern", "ekpr"), ]$cat <- "Male Inflorescence"
df[df$trait %in% c("earm", "tkv", "twkw","knum", "kw"), ]$cat <- "Seed traits"

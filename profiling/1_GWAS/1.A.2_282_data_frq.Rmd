...
######## NEW GENOTYPE #############
plink -bfile hmp321_282_agpv4 --freq --missing --out hmp321_282_agpv4
...
maf <- fread("hmp321_282_agpv4.frq", header=TRUE)
lmiss <- fread("hmp321_282_agpv4.lmiss", header=TRUE)


pdf("hmp321_282_agpv4_maf_lmiss.pdf", width = 10, height=5)
par(mfrow=c(1,2))
hist(maf$MAF, breaks=100, col="#cdb79e", main="MAF (SNP = 71,477,398)", xlab="Minor Allele Freq")
abline(v=0.01, lty=2, col="black", lwd=3)
abline(v=0.05, lty=2, col="red", lwd=3)
...
plink -bfile allchr_bisnp_n282_snpid --maf 0.01 --geno 0.1 --snps-only --make-bed --out allchr_bisnp_n282_snpid_maf01_geno1
## 12961347 variants and 277 people pass filters and QC.

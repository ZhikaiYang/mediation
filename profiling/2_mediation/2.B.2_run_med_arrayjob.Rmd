...
trait <- read.delim("data/N_traits.txt", header=T)
rfile = rfile[1:7] # remove P368
df <- data.frame(rnafile=rep(rfile, each=1), trait=rep(2:2, times=7))
write.table(df, "largedata/df_job_control_nitrogen.csv", sep=",", row.names=FALSE, quote=FALSE)

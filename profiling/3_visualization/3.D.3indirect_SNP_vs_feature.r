...
write.table(out, "largedata/isnps_vs_feature/isnps_56563rows.csv", sep=",", row.names=FALSE, quote=FALSE)

isnps <- fread("largedata/isnps_vs_feature/isnps_56563rows.csv", header=TRUE, data.table=FALSE)
...
fwrite(isnps, "largedata/isnps_vs_feature/isnps_55257rows.csv", sep=",", row.names=FALSE, quote=FALSE)

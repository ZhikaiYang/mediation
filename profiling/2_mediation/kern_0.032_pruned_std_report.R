...
kern <- subset(rna, Tissue %in% c("Kern"))
dim(kern) # 295 37136
# remove the duplicated ones
kern0 <- kern[!duplicated(kern$HMP32Name), ]
dim(kern0) #278 37136

#determine the first column of the gene expression
idx1 <- which(names(kern0) == "AC148152.3_FG001")

X <- kern0[, c(6,10:ncol(kern0))]
...
fwrite(as.list(colnames(X)), "/common/jyanglab/zhikaiyang/projects/mediation-analysis/largedata/code2020/colnamesX_kern.csv", sep=",", row.names=FALSE, quote=FALSE)
fwrite(as.list(colnames(Z)), "/common/jyanglab/zhikaiyang/projects/mediation-analysis/largedata/code2020/colnamesZ_kern.csv", sep=",", row.names=FALSE, quote=FALSE)
...
fwrite(as.list(res.fixed.pcut), "/common/jyanglab/zhikaiyang/projects/mediation-analysis/largedata/code2020/res.fixed.pcut_gddsilk_0.032_pruned_kern.csv", sep=",", row.names=FALSE, quote=FALSE)
...
fwrite(as.list(res.eq.pcut), "/common/jyanglab/zhikaiyang/projects/mediation-analysis/largedata/code2020/res.eq.pcut_gddsilk_0.032_pruned_kern.csv", sep=",", row.names=FALSE, quote=FALSE)
...
fwrite(as.list(res.mix.linear.pcut), "/common/jyanglab/zhikaiyang/projects/mediation-analysis/largedata/code2020/res.mix.linear.pcut_gddsilk_0.032_pruned_kern.csv", sep=",", row.names=FALSE, quote=FALSE)
...
fwrite(as.list(res.mix.shrink.pcut), "/common/jyanglab/zhikaiyang/projects/mediation-analysis/largedata/code2020/res.mix.shrink.pcut_gddsilk_0.032_pruned_kern.csv", sep=",", row.names=FALSE, quote=FALSE)
...
Xcolnames <- fread("/common/jyanglab/zhikaiyang/projects/mediation-analysis/largedata/code2020/colnamesX_kern.csv", data.table=FALSE)
...
if(length(id.fixed) >= 1){fwrite(Xcolnames[id.fixed], "/common/jyanglab/zhikaiyang/projects/mediation-analysis/largedata/code2020/id.fixed_gddsilk_0.032_pruned_kern.csv", sep=",", row.names=FALSE, quote=FALSE)}
directsnps.fixed = reportDirectSNPs(mod.fixed,tests.fixed,pval.cut)
if(length(names(directsnps.fixed$coef.outcome))>=1){fwrite(as.list(names(directsnps.fixed$coef.outcome)), "/common/jyanglab/zhikaiyang/projects/mediation-analysis/largedata/code2020/id.fixed_gddsilk_0.032_pruned_kern_dsnps.csv", sep=",", row.names=FALSE, quote=FALSE)}
indirect_snps.fixed <- reportINDirectSNPs(mod.fixed, e2m.fixed, tests.fixed,pval.cut,Z,colnames_X)
if(nrow(indirect_snps.fixed)>=1){fwrite(indirect_snps.fixed, "/common/jyanglab/zhikaiyang/projects/mediation-analysis/largedata/code2020/id.fixed_gddsilk_0.032_pruned_kern_indirect_snps.csv", sep=",", row.names=FALSE, quote=FALSE)}
...
if(length(id.eq) >= 1){fwrite(Xcolnames[id.eq], "/common/jyanglab/zhikaiyang/projects/mediation-analysis/largedata/code2020/id.eq_gddsilk_0.032_pruned_kern.csv", sep=",", row.names=FALSE, quote=FALSE)}
directsnps.eq = reportDirectSNPs(mod.eq,tests.eq,pval.cut)
if(length(names(directsnps.eq$coef.outcome))>=1){fwrite(as.list(names(directsnps.eq$coef.outcome)), "/common/jyanglab/zhikaiyang/projects/mediation-analysis/largedata/code2020/id.eq_gddsilk_0.032_pruned_kern_dsnps.csv", sep=",", row.names=FALSE, quote=FALSE)}
indirect_snps.eq <- reportINDirectSNPs(mod.eq, e2m.eq, tests.eq,pval.cut,Z,colnames_X)
if(nrow(indirect_snps.eq)>=1){fwrite(indirect_snps.eq, "/common/jyanglab/zhikaiyang/projects/mediation-analysis/largedata/code2020/id.eq_gddsilk_0.032_pruned_kern_indirect_snps.csv", sep=",", row.names=FALSE, quote=FALSE)}
...
if(length(id.mix.linear) >= 1){fwrite(Xcolnames[id.mix.linear], "/common/jyanglab/zhikaiyang/projects/mediation-analysis/largedata/code2020/id.mix.linear_gddsilk_0.032_pruned_kern.csv", sep=",", row.names=FALSE, quote=FALSE)} 

mediators.mix.shrink = reportMediator(mod.mix.shrink,tests.mix.shrink,pval.cut)
id.mix.shrink = mediators.mix.shrink[['pval']]$id
if(length(id.mix.shrink) >= 1){fwrite(Xcolnames[id.mix.shrink], "/common/jyanglab/zhikaiyang/projects/mediation-analysis/largedata/code2020/id.mix.shrink_gddsilk_0.032_pruned_kern.csv", sep=",", row.names=FALSE, quote=FALSE)}

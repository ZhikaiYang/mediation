...
pall <- ggplot(int34ear_overlap_eq, aes(x=tissue, y=o_ratio, fill=category)) +
    ...
    xlab("") +
    ylab("Overlap ratio with enhancer from interactome H3K4me3 in immature ear") +
    ggtitle("") +
    theme_classic() +
    labs(fill = "") +
...
#p7msnps_int34ear: 8181 0.01174508
```{r}

#####change by features########################################################################################
int34ear_overlap_eq$p_f_null = 0.01174508
 
int34ear_overlap_fixed$p_f_null = 0.01174508

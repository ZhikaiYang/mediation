...
tb <- data.frame(sort(table(mg$gene3)))
f1 <- subset(mg, gene3 %in% subset(tb, Freq > 1)$Var1)

write.table(f1, "cache/freq_bg1_gene.csv", sep=",", row.names=FALSE, quote=FALSE)
...
f2 <- subset(f, gene3 %in% c("GRMZM2G000674", "GRMZM2G045005", "GRMZM2G146041", "GRMZM2G171650"))
```

...
if (res_fixed_LeafWidth_p7msnps_L3Tip$n.med >= 1) {
  ...
  id = which(fixed_LeafWidth_p7msnps_L3Tip$padj <= 0.05)
  
  hdf_fixed_LeafWidth_p7msnps_L3Tip_v34 <- filter(Zea_mays.AGPv34_anno, gene3 %in% fixed_LeafWidth_p7msnps_L3Tip$id[id]) 

...
#769690
plink -bfile hmp321_282_agpv4_maf005_miss03 --indep-pairwise 10 kb 10 0.01 --out hmp321_2
#230336
plink -bfile hmp321_282_agpv4_maf005_miss03 --indep-pairwise 10 kb 10 0.001 --out hmp321_2
#195663
plink -bfile hmp321_282_agpv4_maf005_miss03 --indep-pairwise 10 kb 10 0.0001 --out hmp321_2
#189671
plink -bfile hmp321_282_agpv4_maf005_miss03 --indep-pairwise 10 kb 10 0.000001 --out hmp321_2
#187362
...
###subsample SNPs to same size(20000 from 769690)

snp_pr1 <- fread("./largedata/geno/hmp321_282_agpv4_maf005_miss03_pr1.prune.in", header = FALSE, data.table=FALSE)

set.seed(1234)
sam_1 <- sample(769690, size = 20000, replace = FALSE)
sam_1 <- sort(sam_1)

fwrite(as.list(snp_pr1[sam_1, ]), "./largedata/geno/hmp321_282_agpv4_maf005_miss03_pr1_sam_1.txt", sep="\n", row.names=FALSE, col.names = FALSE, quote=FALSE)
...
#sample 20000 out of 769690
plink -bfile  hmp321_282_agpv4_maf005_miss03_pruned --extract hmp321_282_agpv4_maf005_miss03_pr1_sam_1.txt --make-bed --out hmp321_282_agpv4_maf005_miss03_pruned_sam20000

plink --bfile hmp321_282_agpv4_maf005_miss03_pruned_sam20000 --recode vcf-iid --out hmp321_282_agpv4_maf005_miss03_pruned_sam20000

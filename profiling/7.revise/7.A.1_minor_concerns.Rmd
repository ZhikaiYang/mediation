...
#df0 <- subset(df, cat != "1")
pall <- ggplot(rna_bx10_13_g, aes(x=tissue, y=log10(gene_expression +1), fill=gene)) +
    #geom_bar(stat="identity", position=position_dodge()) +
    geom_boxplot(outlier.colour="black", outlier.shape=16, 
             outlier.size=1, notch=FALSE) +
    # scale_fill_manual(values=c("#69b3a2", "#cdc0b0")) +
...
#df0 <- subset(df, cat != "1")
pall_1 <- ggplot(rna_bx10_13_g[which(rna_bx10_13_g$gene == "Bx13"),], aes(x=tissue, y=log10(gene_expression +1), fill=gene)) +
    #geom_bar(stat="identity", position=position_dodge()) +
    geom_boxplot(outlier.colour="black", outlier.shape=16, 
             outlier.size=1, notch=FALSE) +
    # scale_fill_manual(values=c("#69b3a2", "#cdc0b0")) +
...
#df0 <- subset(df, cat != "1")
pall_2 <- ggplot(rna_bx10_13_g[which(rna_bx10_13_g$gene == "Bx12"),], aes(x=tissue, y=log10(gene_expression +1), fill="")) +
    #geom_bar(stat="identity", position=position_dodge()) +
    geom_boxplot(outlier.colour="black", outlier.shape=16, 
             outlier.size=1, notch=FALSE) +
    # scale_fill_manual(values=c("#69b3a2", "#cdc0b0")) +
